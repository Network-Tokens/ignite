...
try:
    ...
    print ("\n-------------------------------------\nIMSI Attach, Detach and Service Request Execution Started\n---------------------------------------")
    ...
    gs.sendGtp('update_bearer_request', update_bearer_request, msg_hierarchy)

    igniteLogger.logger.info("\n---------------------------------------\nMME send Bearer Modify Request/Session Management Request to eNB\n---------------------------------------")
    s1.receiveS1ap()

    igniteLogger.logger.info("\n---------------------------------------\nBearer Modify Response received from eNB\n---------------------------------------")
    s1.sendS1ap('bearer_modify_response', bearer_modify_response, enbues1ap_id_1)

    igniteLogger.logger.info("\n---------------------------------------\nSession Management Response received from eNB\n---------------------------------------")
    s1.sendS1ap('session_management_response', session_management_response, enbues1ap_id_1)

    igniteLogger.logger.info("\n---------------------------------------\nReceive Update Bearer Response from MME\n---------------------------------------")
    gs.receiveGtp()

    # TODO: Verify bearer is created
    # TODO: Modify bearer with QoS update
    # TODO: Verify existing bearer is updated as well as QoS parameters

    # TODO: Bearer Deactivation
    ...
    print ("\n-------------------------------------\nIMSI Attach, Detach and Service Request Execution Successful\n---------------------------------------")
